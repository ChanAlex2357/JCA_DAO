...
public class Requests {
    static public List<Object> findAll(Object entityObject,int offset, int nbPagination,Connection conn,String database) throws NotEntityException, SQLException {
        return find(entityObject, false, null, offset , nbPagination, conn , database);
    }
